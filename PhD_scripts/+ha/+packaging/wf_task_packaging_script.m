...
% Save task widefield aligned to the following events:
...
animal_list = {'DS017','HA005','HA006','HA007','HA008',...
    'HA009','HA010','HA011','HA012','HA013','HA014','HA015','AP030','AP031','AP032'};
        ...
        for day_idx = 1:numel(all_recordings_curr_protocol)
            ...
            if contains(current_protocol,{'two_stim'})
                ...
                if contains(current_protocol,'static')
                    ...
                    task_data(animal_idx).widefield(global_day).first_lick_rewarded_stim_start_to_move_aligned_V= []; % keep it empty for field consistancy
...
right_stim_data= cat(3,single_animal_data.first_lick_rewarded_stim_start_to_move_aligned_V);
...
right_stim_data= cat(3,single_animal_data.first_lick_rewarded_stim_movement_aligned_kernel);
